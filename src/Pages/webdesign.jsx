...
export default function Photography() {
    useEffect(() => {
        ...
        const at_blockElements = document.querySelectorAll(".at_block")
        at_blockElements.forEach(el => observer.observe(el))
    }, []);
    return (
        <>
            ...
            <div className="flex flex-col mx-auto text-center gap-y-[20vw] sm:gap-y-[10vw] md:gap-y-[7.5vw] lg:gap-y-[6vw] xl:gap-y-[5vw] p-[2vw_0vw] sm:p-[2vw_4vw] w-full sm:w-3/4">
                <div className="at_block">
                    ...
                    <div className="mt-[5vw] sm:mt-[2vw] xl:text-[1.3vw]">
                        <h3 className="font-bold mb-[10px] md:mb-[1vw] text-[20px] xl:text-[1.6vw]">不動產學習平台</h3>
                ...
                <div className="at_block">
                    ...
                    <div className="mt-[5vw] sm:mt-[2vw] xl:text-[1.3vw]">
                        <h3 className="font-bold mb-[10px] md:mb-[1vw] text-[20px] xl:text-[1.6vw]">視訊會議裝置</h3>
                        <div>流程/介面設計</div>
                        <div>HTML、Tailwind CSS、Javascript實作</div>
                    </div>
                </div>
